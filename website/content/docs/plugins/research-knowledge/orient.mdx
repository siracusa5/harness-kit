...
> **[View in Marketplace →](https://marketplace.harnessprotocol.io/components/orient)** for install tracking, related plugins, and profiles.
...
{/* @embed plugins/orient/skills/orient/SKILL.md */}

## Plugin Documentation

{/* @embed plugins/orient/skills/orient/README.md */}
