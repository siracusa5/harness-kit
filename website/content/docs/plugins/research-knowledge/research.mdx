...
> **[View in Marketplace →](https://marketplace.harnessprotocol.io/components/research)** for install tracking, related plugins, and profiles.
...
{/* @embed plugins/research/skills/research/README.md */}
