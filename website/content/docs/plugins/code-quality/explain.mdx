...
> **[View in Marketplace →](https://marketplace.harnessprotocol.io/components/explain)** for install tracking, related plugins, and profiles.
...
{/* @embed plugins/explain/skills/explain/SKILL.md */}

## Plugin Documentation

{/* @embed plugins/explain/skills/explain/README.md */}
